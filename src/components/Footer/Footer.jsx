    ...
    <footer className={styles.footer}>
      <div className={styles.footer__container}>
        <div className={styles.footer__layout}>
          ...
          <section className={styles.footer__brandInfo}>
            <h3 className={styles.footer__sectionTitle}>Company Name</h3>
            <p className={styles.footer__brandDescription}>
              Praesent sed lobortis mi. Suspendisse vel placerat ligula. Vivamus
              ac sem lacus. Ut vehicula rhoncus elementum.
            </p>
          </section>
        </div>
        <div className={styles.footer__socialMedia}>
          ...
          <a
            target="_blank"
            href="https://www.facebook.com/theodinproject/"
          >
            <svg
              fill={currentColor}
              viewBox="0 0 24 24"
          ...
          <a
            target="_blank"
            href="https://twitter.com/TheOdinProject"
          >
            <svg
              fill={currentColor}
              viewBox="0 0 24 24"
